...
<div class="p-4 max-w-7xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0">
                <div class="bg-white rounded-lg shadow p-4 border-2 border-green-200">
                    <h3 class="text-sm font-semibold text-gray-700 mb-3">📊 Export Laporan Excel</h3>
                    <form method="GET" action="{{ route('export.monthly-report') }}" class="space-y-3">
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label class="text-xs text-gray-600 block mb-1">Bulan</label>
                                <select name="month" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm">
                                    @for($i = 1; $i <= 12; $i++)
                            ...
                            <div>
                                <label class="text-xs text-gray-600 block mb-1">Tahun</label>
                                <select name="year" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm">
                        ...
                        <button type="submit" class="w-full bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center justify-center space-x-2 transition-colors">
                            <i class="fas fa-file-excel"></i>
                            <span>Export Excel Lengkap</span>
                        </button>
                        
                        <p class="text-xs text-gray-500 text-center">
                            Termasuk: Transaksi, Menu, Stock & Pengeluaran
                        </p>
                    </form>
                </div>
            </div>
    ...
    <!-- Export Info Banner -->
    <div class="mb-6 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg shadow p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold mb-2">📈 Laporan Excel Komprehensif</h2>
                <p class="text-green-100 text-sm">
                    Export semua data dalam satu file Excel: Transaksi bulanan, Detail menu terjual, 
                    Stock movement, dan Pengeluaran bulanan dengan format yang rapi dan mudah dibaca.
                </p>
            </div>
