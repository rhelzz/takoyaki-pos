    ...
    <div class="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div class="px-4 py-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">{{ $stockKeluar->formatted_tanggal }}</p>
                    </div>
                </div>
            ...
            <div x-show="showActions" 
                ...
                <a href="{{ route('stock-keluar.edit', $stockKeluar) }}" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="lg:border-l lg:border-gray-200 lg:pl-6">
                    <div class="bg-orange-50 rounded-lg p-4">
                        <h3 class="text-sm font-medium text-gray-700 mb-2">Quantity Keluar</h3>
                        <div class="text-2xl lg:text-3xl font-bold text-orange-600">
                            -{{ $stockKeluar->qty }}
                        </div>
                    </div>
                </div>
...
function stockDetail() {
    return {
        ...
        deleteStock() {
            if (confirm('Apakah Anda yakin ingin menghapus stock keluar ini?')) {
                fetch('{{ route("stock-keluar.destroy", $stockKeluar) }}', {
                    method: 'DELETE',
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        setTimeout(() => {
                            window.location.href = '{{ route("stock-keluar.index") }}';
                        }, 1000);
                    } else {
