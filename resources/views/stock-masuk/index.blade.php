    ...
    <div class="p-4 max-w-6xl mx-auto space-y-4">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('stock-masuk.show', $row) }}"
                                ...
                                <form action="{{ route('stock-masuk.destroy', $row) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button type="submit"
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="text-center py-12 text-gray-500">Belum ada data stock masuk</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="sm:hidden divide-y divide-gray-100">
                    ...
                    <div class="py-3 px-4 flex flex-col gap-2">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <div class="font-bold text-blue-700">{{ $row->judul }}</div>
                            </div>
                ...
                @empty
                    <div class="py-10 text-center text-gray-500">Belum ada data stock masuk</div>
                @endforelse
            </div>
