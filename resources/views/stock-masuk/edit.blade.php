...
<div class="min-h-screen bg-gray-50" x-data="stockFormEdit()">
    ...
    <div class="p-4 max-w-2xl mx-auto">
        <form action="{{ route('stock-masuk.update', $stockMasuk) }}" method="POST" class="space-y-4" @submit="prepareSubmit">
            @csrf
            @method('PUT')
...
function stockFormEdit() {
    return {
        toppings: @json($stockMasuk->toppings ?? []),
        packagings: @json($stockMasuk->packagings ?? []),
        toppingsJson: '',
        packagingsJson: '',
